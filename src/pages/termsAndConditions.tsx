export default function TermsAndConditions() {
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <p>Para consultas sobre los términos, escribinos a: <a className="text-blue-600 underline" href="mailto:contacto@imgestion.com.ar">contacto@imgestion.com.ar</a></p>
    </div>
  );
}
