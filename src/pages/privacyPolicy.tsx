export default function PrivacyPolicy() {
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <p>Si tenés preguntas sobre esta política, podés contactarnos en: <a className="text-blue-600 underline" href="mailto:contacto@imgestion.com.ar">contacto@imgestion.com.ar</a></p>
    </div>
  );
}
